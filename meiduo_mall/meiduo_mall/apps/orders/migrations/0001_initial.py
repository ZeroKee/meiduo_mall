# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-07-13 03:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_auto_20180702_0318'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('goods', '0003_auto_20180706_0812'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(4, '待评价'), (1, '待支付'), (3, '待收货'), (5, '已完成'), (2, '待发货'), (6, '已取消')], default=1, verbose_name='订单状态')),
